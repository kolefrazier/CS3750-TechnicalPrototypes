...
namespace CS3750TechnicalPrototypes.Controllers
{
    public class AuctionController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AuctionID,AuctionName,StartDate,EndDate,OpeningBid,EventId")] Auction auction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AuctionID,AuctionName,StartDate,EndDate,OpeningBid,EventId")] Auction auction)
        {
